#####CASO MONTAÑA#####
##Fecha de comienzo: 18/10/2019
##Autor: Jose Javier Martin Garcia
##Fecha de finalicacion: 19/10/2019
##Asignatura: Fundamentos para el Analisis de Datos


#El parking exterior de un hotel de montaÃ±a estÃ¡ limitado a cinco plazas
#Los conductores que lo usan llegan siguiendo una distribuciÃ³n de 
#Poisson con frecuencia de 6 por hora El tiempo de estacionamiento
#tiene distribuciÃ³n exponencial con 30 minutos de promedio Los
...
#salga un automÃ³vil, pero sÃ³lo pueden permanecer en espera 3
#vehiculos Los vehiculos que no pueden aparcar ni tampoco quedan
...
#d) El tiempo medio que espera un auto para estacionar,
#estando en una plaza provisional

#En este caso debemos mirar los estados del 6 al 8 ya que hasta el quinto pueden aparcar
#al admitir dicho parking 5 plazas y hasta 8 los 3 ultimos son los que deben esperar 
#su turno por eso miramos los 3 estados finales.
...
#la cantidad media de plazas ocupadas es igual al maximo de plazas posibles que en
#este caso es 6
