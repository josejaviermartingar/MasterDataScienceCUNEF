...
datos3 <- read.csv("C:/Users/Equipo/Desktop/CUNEF/Fundamentos para el Analisis de Datos/Practicas/pesos.csv")
...
#Ofrece el resumen estad?stico para los distintos grupos da una visualizacion 
#los agrupa 
...
# Grafico por peso y grupo boxplot da info del min del max y de los cuartiles (simetria)
