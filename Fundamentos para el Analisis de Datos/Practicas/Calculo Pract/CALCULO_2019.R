###########MATEM?TICAS ESENCIALES PARA EL DATA SCIENCE##############
...
#Cargar nloptr desde Packages para optimizar funciones
#Activar
library(nloptr)
...
#Ofrece el primer m?n. encontrado

optimize(f, c(0,3), lower = 0, upper=3) 

#Ofrece el m?n. global
